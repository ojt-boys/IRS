...
const tableData = ref([
  ...
  { batch: 2, id: 4, branch: "102", service: "Sole Replacement", shoe: "Reebok Classic", status: "Completed", dateTime: "2025-03-08 10:15" },
]);
...
const statusColor = (status: string) => {
  if (status === "Ready to Pick Up") return "bg-yellow-500 text-black";
